...
var ob = [new rect(100,180,100,25,'grey'),new rect(0,50,150,20, 'grey'), new rect(0,500,1200,40,'grey'),new rect (700,420,900,25,'gray'), new rect (100,400,20,200,'grey'), new rect (200,400,20,200,'grey')];
var moveright = true;
var levels = [()=>{
