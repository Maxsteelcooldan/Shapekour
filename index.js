...
var ob = [new rect(100,180,100,25,'grey'),new rect(0,50,150,20, 'grey'), new rect(0,500,1200,40,'grey'),new rect (700,420,900,25,'gray'), new rect (0,350,35,300,'grey'), new rect (100,350,20,300,'grey')];
var moveright = true;
var levels = [()=>{
