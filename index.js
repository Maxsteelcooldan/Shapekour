...
var ob = [new rect(100,180,100,25,'grey'),new rect(0,50,150,20, 'grey'), new rect(0,500,1200,40,'grey'),new rect (700,420,900,25,'gray'), new rect (185,400,20,200,'grey'), new rect (250,366,20,134,'grey')];
var moveright = true;
var levels = [()=>{
